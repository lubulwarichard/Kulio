...
class SearchFlightsPresenter(var view: HomeContract.View) : HomeContract.Presenter {
    ...
    override fun findScheduledFlights(origin: String, destination: String, dateTime: String, offset: Int, fetchCount: Int) {
        view.findScheduledFlightsStarted()

        mAPIService.getFlights(origin, destination, dateTime, fetchCount, offset)
            .retry(3)
